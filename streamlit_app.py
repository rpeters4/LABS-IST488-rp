...
lab_ma = st.Page("Lab_MA.py", title="Lab MA: Multi-Agent", icon=":material/groups:")
lab9 = st.Page("Lab_9.py", title="Lab 9: Memory Chatbot", icon=":material/psychology:", default=True)

# Create navigation
pg = st.navigation([lab1, lab2, lab3, lab4, lab5, lab6a, lab6b, lab_ma, lab9])
