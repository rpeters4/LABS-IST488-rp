...
\begin{enumerate}[nosep, start=3]
  \item Compare the two responses side-by-side. Note the differences in data quality, structure, and specificity. You will reflect on these observations in the Write-Up Questions at the end of this document.
\end{enumerate}
...
Answer the following questions in a separate document (submitted via Blackboard or as a text file). Each response should be 3--5 sentences unless otherwise specified.
...
\noindent\textbf{Question 2: Single-Agent vs.\ Multi-Agent Comparison}\\
...
\noindent\textbf{Question 3: Trade-offs}\\
...
\noindent\textbf{Question 4: MessagesState \& StateGraph}\\
...
\begin{enumerate}[nosep, label=\alph*)]
  ...
  \item How does \texttt{create\_supervisor()} from Parts 1--5 relate to the \texttt{StateGraph} you built manually? What does it do for you automatically?
\end{enumerate}
...
\begin{itemize}[nosep]
  ...
  \item[$\square$] Write-up with answers to all 4 questions
\end{itemize}
